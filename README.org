...
Docker images can be archived with the command
: docker save felix11/my-image > my-image.tar
and images can be restored from an archive with
: docker load < my-image.tar
Uploading the ~.tar~ archives allows for unique identification via a DOI. This [[https://www.software.ac.uk/blog/2016-09-12-reproducible-research-citing-your-execution-environment-using-docker-and-doi][article]] goes into some more detail.
