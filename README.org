...
- Bremges et al. (2015) /Deeply sequenced metagenome and metatranscriptome of a biogas-producing microbial community from an agricultural production-scale biogas plant/ [[https://gigascience.biomedcentral.com/articles/10.1186/s13742-015-0073-6][gigascience.biomedcentral.com]]
  : Dockerfile and GitHub repository included. Link to 
  : Docker Hub seems already deprecated. Did not archive 
  : Docker image or GitHub repository. Good: Comment on 
  : the resources necessary to complete all computations
